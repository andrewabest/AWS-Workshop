...
"@
	...
	$cleanupScriptsS3BucketKey = GenerateConfigFileS3Key -environment $OctopusParameters['Environment'] -release $OctopusParameters['Version'] -filename "Cleanup.ps1"
	...
	$powerShellModulesS3BucketKey = GenerateConfigFileS3Key -environment $OctopusParameters['Environment'] -release $OctopusParameters['Version'] -filename "PowerShellModules.zip"
	...
	$scriptsS3BucketKey = GenerateConfigFileS3Key -environment $OctopusParameters['Environment'] -release $OctopusParameters['Version'] -filename "Scripts.zip"
	...
	$webserverTemplateS3BucketKey = GenerateConfigFileS3Key -environment $OctopusParameters['Environment'] -release $OctopusParameters['Version'] -filename "Webserver.template"
	...
	$mainTemplateS3BucketKey = GenerateConfigFileS3Key -environment $OctopusParameters['Environment'] -release $OctopusParameters['Version'] -filename "Zephyr.template"
	...
	$stackParameters = `
		...
		@{ParameterKey="Version"; ParameterValue=$OctopusParameters['Version']},`
		@{ParameterKey="Environment"; ParameterValue=$OctopusParameters['Environment']},`
